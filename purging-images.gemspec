...
Gem::Specification.new do |spec|
  ...
  spec.summary       = %q{If you need to remove or update an image on imgix, you can purge it from our caches. }
  spec.description   = %q{If you need to remove or update an image on imgix, you can purge it from our caches. }
  spec.homepage      = "https://docs.imgix.com/setup/purging-images"
  spec.license       = "MIT"
